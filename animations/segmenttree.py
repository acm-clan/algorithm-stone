...
class SegmentTreeDiffScene(AlgoScene):
    ...
    def show_diff(self):
        ...
        self.show_messaged("前缀和、树状数组、线段树")

        self.show_messaged("前缀和一般用于固定的数组")
        
        self.show_messaged("树状数组是一种很高效的数据结构")
        self.show_messaged("功能能满足大部分需求")

        self.show_messaged("线段树则是一种非常灵活的数据结构")
        self.show_messaged("本动画重点讲解线段树")
